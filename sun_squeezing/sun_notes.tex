...
\begin{align}
  H_{\t{lat}}^{(\phi)}
  = -\sum_q \sp{\cos\p{qa} \sum_{J\,\t{even}} B_J D_{J,0}^{(q)}
    - \sin\p{qa} \sum_{J\,\t{odd}} B_J D_{J,0}^{(q)}},
\end{align}
where the effective ``fields'' $B_J$ take the form
\begin{align}
  \left. B_J \right|_{J\,\t{even}}
  = \f12 \sum_\mu \obk{D_{J,0}|s_{\mu\mu}} \cos\p{\mu\phi},
  &&
  \left. B_J \right|_{J\,\t{odd}}
  = \f12 \sum_\mu \obk{D_{J,0}|s_{\mu\mu}} \sin\p{\mu\phi}.
\end{align}
