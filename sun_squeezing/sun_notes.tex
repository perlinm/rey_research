...
gauge transformation) proportional to the Hamiltonian induced on a
spin-$n$ system by a classical driving laser.  In terms of the drive
operators,
\begin{align}
...
are realized with nuclear spin (angular momentum) states, however, the
