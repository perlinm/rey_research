...
\end{align}
where $\p{S_\z,S_\x,S_\y} \equiv \xi_1\times\p{D_{1,0},D_{1,1},D_{1,-1}}$ is the standard $\mathfrak{su}(2)$ subalgebra of the operators on a single $n$-level spin, and
\begin{align}
...
\begin{table}
  ...
  \begin{tabular}{c|c|c}
    ...
    \\ \hline
    $\Omega_+=\Omega_-=0$ & $\p{1,0,0}$ & $-S_\z^2$
    \\ \hline
