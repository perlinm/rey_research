...
\begin{table}
  ...
  \begin{tabular}{c|c|c}
    ...
    $\Omega_0=\Omega_+=+\Omega_-$ & $\p{1,\sqrt{2},0}$
    & $\sqrt{2} S_\x + S_\x^2 - S_\y^2$ \\ \hline
    $\Omega_0=\Omega_+=-\Omega_-$ & $\p{1,0,\sqrt{2}}$
    & $\sqrt{2}\p{S_\z S_\x + S_\x S_\z} - \p{S_\x^2-S_\y^2}$ \\ \hline
    $\Omega_+=\Omega_-=0$ & $\p{1,0,0}$
    & $S_\x^2 + S_\y^2$ \\ \hline
    $\Omega_0=\Omega_-=0$ & $\p{0,1,+1}$
    & $+S_\z - \p{S_\x^2 + S_\y^2}$ \\ \hline
    $\Omega_0=\Omega_+=0$ & $\p{0,1,-1}$
    & $-S_\z - \p{S_\x^2 + S_\y^2}$
  \end{tabular}
  \label{tab:drives}
\end{table}
