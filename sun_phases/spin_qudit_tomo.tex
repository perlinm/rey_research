...
While $\E_V\p{\rho_V^\star}^2$ is a strict upper bound on $\E_V\p{\rho}^2$ over all $\rho$ with $\tr\p{\rho}=1$, this bound turns out to be useless in practice, because $\rho_V^\star$ will generally be a non-physical ``state'' with negative eigenvalues.
