...
where
\begin{align}
  \S_V^2 \equiv \obk{M_V^{-1}|M_V^{-1}} = \sum_k\f1{\p{M^V_k}^2},
\end{align}
...
\begin{align}
  ...
  &&
  \S_{V\ell}^2 \equiv \obk{M_{V\ell}^{-1}|M_{V\ell}^{-1}},
\end{align}
...
\end{align}
is the variance of the entries of $X$ when sampled according to the (classical) probability distribution $p$.
...
\begin{align}
  ...
  = \bk{\v v_i | \p{\Sigma_{V\ell}^{-1} W_{V\ell}^\dag}^\dag
    \p{\Sigma_{V\ell}^{-1} W_{V\ell}^\dag} | \v v_i}
