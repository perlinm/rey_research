...
Though the result in Eq.~\eqref{eq:variance_bound} is sufficient to proceed with our derivation of an improved tomographic reconstruction error bound, we first take some time to better understand the bound on $\bbk{\epsilon_{i\ell}^2}$ analytically.
...
\begin{align}
  \sigma_p^2\p{t_\ell} \le \sum_\mu t_{\ell\mu}^2 p_\mu
