...
\item Denoting the nonzero singular values of $M_{V\ell}$ by $M^V_{\ell k}$ and the corresponding right singular vectors by $\v x^V_{\ell k} = \sum_{\v v} x^V_{\ell k \v v} \ket{\v v}$, compute the coefficients and operators
  \begin{align}
