...
The remainder of this section is devoted to defining $\epsilon_V^2$, which is derived in Appendix \ref{sec:error}, and can be skipped without consequence for the discussions in the rest of this paper.
...
\begin{align}
  \ket{\chi_{VL}}
  &\equiv \sum_{M=-L}^L \chi^V_{LM} \ket{M}, \\
...
\end{align}
in terms of which we have that $\epsilon_V^2 \equiv \sum_\ell \epsilon_{V\ell}^2$, with
\begin{align}
