...
\begin{abstract}
  ...
  We conjecture that $r_d=2d-1$, which we have verified for all $d\le150$ using numerical experiments.
...
Nonetheless, we have used the tomography protocol in the next section to numerically verify that $2d-1$ measurement axes suffice for all $d\le150$.
