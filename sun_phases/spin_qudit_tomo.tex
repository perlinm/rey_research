...
The polarization operators $T_{\ell m}$ are a quantum analogue of spherical harmonics $Y_{\ell m}$, which play an important role in phase-space formalisms for spin qudits \cite{li2013weylwignermoyal}.
