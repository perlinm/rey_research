...
In this work, we provide a new and simple framework for performing spin qudit tomography.
We begin by mapping this quantum tomography problem onto the well-studied classical problem of signal recovery on the sphere, thereby importing a host of existing literature and machinery that has been developed for this task \cite{mcewen2011novel, mcewen2011sampling, rauhut2011sparse, alem2012sparse, khalid2014optimaldimensionality}.

[\red{finish intro, provide outline of the paper}]
...
\end{align}
is an inner product of the functions $\D^\ell_{m,0}$ and $Y_{\ell n}$ [\red{does this need to be derived in its own Appendix?}].
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Tomographic protocol and numerical experiments}
