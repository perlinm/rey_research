...
where
\begin{align}
  \epsilon_{V\ell}^2 \stackrel{\ell>0}{\equiv} \f14 \bk{\chi_{V\ell}|\N_{V\ell}^{-1}|\chi_{V\ell}},
  &&
  \epsilon_{V,0}^2
  \equiv \f{\bk{\chi_{V,0}|0}}{\sqrt{d}} - \f{\bk{0|\N_{V,0}|0}}{d}
  = \f1d \sum_{\ell>0} \tr\p{\N_{V\ell}}.
\end{align}
