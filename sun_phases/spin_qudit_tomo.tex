...
\begin{align}
  \epsilon_V^2 \equiv \sum_{\ell>0} \sp{\f14 \bk{\chi_{V\ell}|\N_{V\ell}^{-1}|\chi_{V\ell}}
    + \f1d \tr\p{\N_{V\ell}}}.
\end{align}
Note that the maximum of Eq.~\eqref{eq:error_simp} may generally occur at an unphysical ``state'' $\rho$ with negative eigenvalues.
...
\begin{align}
  \ket{\chi_{V\ell}}
  - \sp{\N_{V\ell} + \I N_{V\ell}^* \I} \ket{\rho_{V\ell}^\star}
  = \ket{\chi_{V\ell}}
  - 2 \N_{V\ell} \ket{\rho_{V\ell}^\star}
  \stackrel{\ell>0}{=} 0,
\end{align}
which implies that
\begin{align}
...
\begin{align}
  \epsilon_V^2
  \equiv \sum_{\ell>0} \f14 \bk{\chi_{V\ell}|\N_{V\ell}^{-1}|\chi_{V\ell}}
  + \sp{\f{\bk{\chi_{V,0}|0}}{\sqrt{d}} - \f{\bk{0|\N_{V,0}|0}}{d}}
  = \sum_{\ell>0} \sp{\f14 \bk{\chi_{V\ell}|\N_{V\ell}^{-1}|\chi_{V\ell}}
    + \f1d \tr\p{\N_{V\ell}}}.
\end{align}
