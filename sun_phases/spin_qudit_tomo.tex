...
\begin{align}
  C_{V\ell} \equiv \sum_i C_{V\ell i} \op{i},
  &&
  C_{V\ell i} \equiv \f1{\p{M^V_{\ell m}}^2} \sum_m \abs{x_{\ell m i}}^2.
\end{align}
...
This expansion allows us to express the error in Eq.~\eqref{eq:error_full_start} more compactly as
\begin{align}
  \Bbk{\norm{\tilde\rho_V-\rho}^2}
...
\begin{align}
  ...
  = \sum_{m,n} \sp{\delta_{mn} \bk{T_{\ell m}^\dag T_{\ell m}}_\rho
    - \bk{T_{\ell m}^\dag}_\rho \bk{T_{\ell n}}_\rho} \op{m}{n}.
\end{align}
