...
Figure \ref{fig:mean_op_ss_X} shows the long-time averages of the transverse magnetization $\bar\sigma_\x$ and interaction energy $\ss$ as computed by mean-field simulations of $N=100$ spins in an initial $x$-polarized state $\ket{+\x}^{\otimes N}$.
