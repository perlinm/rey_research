...
\begin{align}
  ...
  &= \f12 \sp{1 + \p{-1}^{L+\ell_1+\ell_2}
    \epsilon_{m_1} \epsilon_{m_2}} D_{L,0}, \\
  E_{\ell_1 m;\ell_2 m}^{(L,-)}
  &= \f12 \sp{\epsilon_{m_2} + \p{-1}^{L+\ell_1+\ell_2}
    \epsilon_{m_1}} D_{L,0},
\end{align}
and are otherwise
\begin{align}
  E_{\ell_1 m_1;\ell_2 m_2}^{(L,+)}
  &\stackrel{m_1+m_2\ne0}{=}
  \f{\tau_{m_1+m_2}^*}{2} \sum_{s\in\set{\pm1}}
  \sp{1 + s \p{-1}^{L+\ell_1+\ell_2}
    \epsilon_{m_1} \epsilon_{m_2} \epsilon_{m_1+m_2}}
  \sqrt{s} D_{L,s\p{m_1+m_2}}, \\
  E_{\ell_1 m_1;\ell_2 m_2}^{(L,-)}
  &\stackrel{m_1-m_2\ne0}{=}
  \f{\tau_{m_1-m_2}^*}{2} \sum_{s\in\set{\pm1}}
  \sp{\epsilon_{m_2} + s \p{-1}^{L+\ell_1+\ell_2}
