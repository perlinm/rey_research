...
\end{align}
Note that $\D_{0,0}$ is proportional to the identity operator, so the
amplitude $\Omega_{0,0}$ can be neglected without consequence.  If
$\Omega_0=\Omega_+=\Omega_-=\xi_1\Omega$, then all remaining
amplitudes except $\Omega_{1,1}$ and $\Omega_{2,2}$ vanish, and the
Raman drive becomes
\begin{align}
...
$\Omega_0=\pm\Omega_\pm=\xi_1\Omega$, then all amplitudes except
$\Omega_{2,1}$ and $\Omega_{2,2}$ vanish, and the drive becomes
\begin{align}
  H_{\t{Raman}}^{(-)} \equiv \f{\Omega^2}{\Delta}
