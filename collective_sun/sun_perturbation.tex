...
index; that is (pay attention to the second sum in each line),
\begin{align}
...
\begin{multline}
  ...
  \EQFS \f14 \diagram{two_body_0} O_{1,2} Q_{3,4}
...
\begin{align}
  \diagram{two_body_1}
  &= \diagram{two_body_1_o} - \diagram{two_body_1_x} \\
  &= \diagram{two_body_1_oo} - \diagram{two_body_1_ox}
...
\begin{align}
  \diagram{two_body_0}
  &= \diagram{two_body_0_o} - \diagram{two_body_0_x} \\
  &= \sp{\diagram{two_body_0_oo} - \diagram{two_body_0_ox}}
  - 2 \sp{\diagram{two_body_1}} \\
  &= \sp{-2 \diagram{two_body_1_o}}
  - 2 \sp{\diagram{two_body_1_oo} - \diagram{two_body_2}} \\
  &= -4 \diagram{two_body_1_oo} + 2 \diagram{two_body_2} \\
...
with
\begin{align}
  A_6 \equiv \f18 \diagram{triple_0},
  &&
  A_4 \equiv \diagram{triple_1} + \f32 \diagram{triple_01},
  \label{eq:triple_64}
\end{align}
\begin{align}
  A_2 \equiv \f12 \diagram{triple_2} + 3 \diagram{triple_11}
  + \f34 \diagram{triple_02} + 3 \diagram{triple_011},
  \label{eq:triple_2}
\end{align}
where a diagram with unlabeled circles denotes an average over all
label assignments that result in a distinct diagram, e.g.
\begin{align}
  \diagram{triple_0} \equiv \diagram{triple_0_uvw},
  \label{eq:triple_uvw}
\end{align}
\begin{align}
  \diagram{triple_011}
  \equiv \f13 \sp{\diagram{triple_011_uvw}
...
Eliminating all filled dots in regions that address only one tensor
yields:
\begin{align}
  A_6 = D_1 - D_2 + D_3 - D_4,
\end{align}
...
where
\begin{align}
  D_1 \equiv \f18 \diagram{triple_0_o6},
  &&
  D_2 \equiv \f32 \diagram{triple_01_o4}
  - 2 \diagram{triple_1_o3},
  &&
  D_4 \equiv \diagram{triple_0111}.
\end{align}
\begin{align}
  D_3 \equiv 3 \diagram{triple_011_o2}
  + \f34 \diagram{triple_02_o2}
  - 6 \diagram{triple_11_o}
  + 2 \diagram{triple_2}.
\end{align}
...
we can expand
\begin{align}
  D_1 = \col{u}\,\col{v}\,\col{w},
  &&
  D_2 = \col{u}\,\v v\c\v w + \col{v}\,\v w\c\v u
  + \col{w}\,\v u\c\v v - 2 \sum_p u_p v_p w_p,
  &&
  D_4 = \tr\p{\m u \c \m v \c \m w},
\end{align}
\begin{multline}
  D_3 = \v u \c\m v\c\v w + \v v \c\m w\c\v u + \v w \c\m u\c\v v
...
\end{multline}
Finally, we also write the product $\X$ in \eqref{eq:triple_multi}
using the collective operator $\col{X} \equiv \sum_p X_p$:
\begin{align}
  \X \EQFS
