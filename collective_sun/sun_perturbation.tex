...
$\check{\m h}$ defined in \eqref{eq:V2_eig_mat} by $\v{\m w}_\Delta$,
and define
\begin{align}
...
interaction energy nominally requires diagonalizing an
...
\red{TODO: write codes to check above work, fix any errors, explicitly
  write out two-body reduced eigenvalue problems, include sub-section
  about isotropy, replace the following appendix}
