...
equivalence class of $\tilde k_{ap}$ (where $\tilde k_{ap}$ equal to
$\tilde k$ with the $a$-th spin $k_a$ replaced by $p$); and we define
$\ket{k}=0$ if $\tilde k$ has any repeated values.  The matrix
