...
$\C_N\p{M}$ into equivalence classes $\S_M$\footnote{For brevity, we
...
consideration.  To this end, for any equivalence class $s\in\S_M$ we
define a uniform superposition $\ket{s}$ over all choices $k\in s$, as
well as the projector $\P_\S$ onto the space of uniform
superpositions:
\begin{align}
