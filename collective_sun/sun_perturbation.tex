...
introduction of $M$-body operators with $M>2$ \red{[todo: explain why
  better]}. Generalizing the above examples to the case of SU($n$)
systems, we therefore consider a general $M$-body operator of the form
\begin{align}
...
\begin{align}
  ...
  \label{eq:H_eff_2_1}
\end{align}
In the SU(2) case, this result implies that an inhomogeneous magnetic
field ($X=s_\z$) yields the OAT Hamiltonian $H_{\t{OAT}}$ in
\eqref{eq:OAT} at second order perturbation theory.
