...
% \eqref{eq:cond_1} with eigenvalue $0$, which implies that all
% vectors $\v v$ satisfying \eqref{eq:cond_1} with $\Delta\ne0$ must
% be orthogonal to $\v\1$, and therefore mean-zero.
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \subsubsection{Two-body excitation energy eigenstates}
% \label{sec:trans_inv_two}

% The single-body excitation energy eigenvalue problem in
% \eqref{eq:H_V1_psi_eig} is solvable analytically when the interaction
% Hamiltonian $H_0$ is translationally invariant.
