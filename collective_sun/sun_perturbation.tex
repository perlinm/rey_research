...
\begin{align}
  ...
  &&
  A_4 \equiv \diagram{triple_1} + \f12 \diagram{triple_01},
  \label{eq:triple_64}
\end{align}
\begin{align}
  A_2 \equiv \f12 \diagram{triple_2} + \diagram{triple_11}
  + \f14 \diagram{triple_02} + \diagram{triple_011},
  \label{eq:triple_2}
\end{align}
where we have neglected scalar terms without physical consequence, and
a diagram with unlabeled circles denotes a sum over all distinct label
assignments, e.g.
\begin{align}
...
\begin{align}
  ...
  &&
  D_1 \equiv \f12 \diagram{triple_01_o4} - 2 \diagram{triple_1_o3},
  &&
  D_3 \equiv \diagram{triple_0111},
\end{align}
\begin{align}
  D_2 \equiv \diagram{triple_011_o2}
  + \f14 \diagram{triple_02_o2}
