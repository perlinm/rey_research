...
We first consider the single-body case and simplify
\begin{align}
  H_0 \V_1 \ket\psi
...
\red{TODO: Discuss motivation, why we care about these products
  (answer: they appear in perturbation theory, as well as the
  calculation of matrix elements within the outer-most ``shells'' of
  fixed net spin).  Give an example of the diagram expansions we're
  after.}
...
q$g$, where $\PP\p{\ZZ_p}$ is the power set (i.e.~set of all subsets)
