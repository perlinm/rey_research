...
\item Reflecting the changes to section III.D, we have re-arranged
  some of the text in Section III.E so that these two sections have a
  similar structure.  To this end, we have replaced the following text
  (page 21, line 49):
