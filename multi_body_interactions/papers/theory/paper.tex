...
$E_n=\p{3/2+n_x+n_y+n_z}\omega$ for an on-site angular trap frequency
$\omega$ (with the reduced Planck constant $\hbar=1$ throughout this
paper), but in general the aharmonicity of the lattice potential will
cause a non-negligible shift in motional state energies.
