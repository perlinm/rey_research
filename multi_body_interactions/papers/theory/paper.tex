...
lattice sites.  Doubly-excited states are manifestly off-resonant for
single-photon absorption processes as $\abs{\Delta}\ll\omega_0$, while
multi-photon absorption processes are always off-resonant due to
\begin{enumerate*}
...
interacting atoms' orbital excitation spectrum.  Formally, corrections
to the spectrum of interacting atoms can be accounted for by a
perturbative treatment of far-off-resonant terms in the interaction
Hamiltonian of \eqref{eq:H_int} that create atoms in excited motional
states,
...
\item facilitate a comparison with the experimental measurements of
  ...
  ref.~\cite{goban2018emergence} andr
