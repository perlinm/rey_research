...
\begin{figure}
  \centering \includegraphics{squeezing_comparison_FH.pdf}
...
% \note{[MP] Future ideas:} Make use of a cavity to enhance the
% one-axis twisting strength \cite{hu2017vacuum}?
