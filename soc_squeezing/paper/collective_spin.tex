...
% typically resulting in a one-axis twising (OAT) model described by
% the Hamiltonian\cite{kitagawa1993squeezed}
% \begin{align}
%   H_{\t{OAT}} = \chi S_\z^2,
%   \label{eq:OAT}
% \end{align}
...
% $t\sim\chi^{-1}N^{-2/3}$\cite{ma2011quantum}.
...
% Various works have proposed improvements over OAT through the
% addition of auxiliary control fields\cite{law2001coherent,
% liu2011spin, huang2015twoaxis, muessel2015twistandturn} or a
% modified vacuum\cite{hu2017vacuum}, thereby realizing different
% collective spin models.

% While the OAT model admits exact
% solutions\cite{foss-feig2013nonequilibrium}, the same is not true of
% more general, non-Ising Hamiltonians.  Nonetheless,
