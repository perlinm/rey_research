...
\begin{align}
  ...
  \sum_{j_a^\mu=j_b^\nu \iff \p{a,\mu}=\p{b,\nu}} X_{\v j},
  &&
  P_{\v m\v j} \equiv \prod_{\mu,a} \sigma_\mu^{\p{j_a^\mu}}.
\end{align}
...
\end{align}
\begin{align}
  \abs{\set{J_a^\mu}} = \sum_\mu\p{m_\mu+n_\mu} - 2 s,
  &&
  \abs{\set{K_a^{\mu\nu}}} = s,
  &&
  \set{J_a^\mu} \cap \set{K_a^{\mu\nu}} = \set{};
\end{align}
...
and finally
\begin{align}
  Q_{\v r\v J} \equiv \prod_{\mu,a} \sigma_\mu^{(J_a^\mu)},
  &&
