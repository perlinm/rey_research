...
\begin{align}
  ...
  = \sum_{q=0}^p \mu^q \zeta_{mnp}^{(q)} S_\z^q,
  \label{eq:Z_mn}
\end{align}
with
\begin{align}
...
\end{align}
using which we can compute, for $\bmu\equiv-\mu\in\set{+1,-1}$ and
$\bnu\equiv-\nu\in\set{+1,-1}$,
\begin{align}
