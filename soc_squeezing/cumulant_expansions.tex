...
\begin{align}
  \S_{\v m}\S_{\v n}
  = \sum_{s\ge0} \sum_{\p{\v r;\v m,\v n,s}}
  \sum_{\p{\v J,\v K;\v m,\v n,\v r}} f_{\v m\v n\v r} P_{\v J} Q_{\v K},
  \label{eq:SS_PQ}
\end{align}
...
over $\p{\v r;\v m,\v n,s}$ denotes a sum over all values of $\v r$ with the restrictions
\begin{align}
  r_{\mu\nu} \ge 0 ~\forall~ \mu,\nu,
  &&
  \sum_\nu r_{\mu\nu} \le m_\mu,
  ...
  \label{eq:rest_r}
\end{align}
the sum over $\p{\v J,\v K;\v m,\v n,\v r}$ denotes a sum over all
values of $\v J,\v K$ with the restrictions
\begin{align}
  \abs{\set{J_a^\mu}}
...
\begin{align}
  \S_{\v m} \S_{\v n}
  = \sum_{s\ge0} \sum_{\p{\v r;\v m,\v n,s}} \sum_{\p{\v\rho;\v r}}
  \sum_{\p{\v\ell;\v m,\v n,\v r,\v\rho}}
  f_{\v m\v n\v r} g_{\v\rho} \v\eta_{\v\rho} c_{\v\ell\v\rho} P_{\v\ell},
  \label{eq:SS_simp}
\end{align}
where the sums over $\p{\v\rho;\v r}$ and
$\p{\v\ell;\v m,\v n,\v r,\v\rho}$ respectively denote sums over all
values of $\v\rho$ and $\v\ell$ with the restrictions
\begin{align}
  \sum_{\kappa} \rho^{\mu\nu}_\kappa = r_{\mu\nu},
  &&
  \abs{\set{\ell^\mu_a}}
...
\end{align}
with $\abs{\v\ell}$ equal to the number of elements in $\v\ell$,
...
$\rho^{\mu\nu}_\kappa,\eta_{\mu\nu\kappa}$ ever matches the index for
...
$\eta_{\mu\nu\kappa}$, which will appear in $\v\eta_{\v\rho}$ as
defined in \eqref{eq:eta_rho}, by restricting $\rho^{\mu\nu}_\kappa=0$
for all $\mu,\nu,\kappa$ with $\eta_{\mu\nu\kappa}=0$.  These
restrictions are sufficient to ensure that all individual terms in
\eqref{eq:SS_simp} are nonzero, although they do not rule out the
possibility of several terms canceling out.
