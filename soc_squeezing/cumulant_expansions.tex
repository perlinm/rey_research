...
\begin{align}
  ...
  + \p{\gamma_\z^* \gamma_\mu + \gamma_\bmu^* \gamma_\z} K_{\ell mn;\mu}
...
\begin{align}
  ...
  &\qquad -\f12 \sum_\mu\p{\Gamma_\bmu^* \Gamma_\mu \sp{S_\mu^2, \O}_+
    + \Gamma_z^*\Gamma_\mu \sp{S_\z S_\mu, \O}_+
...
\begin{align}
  ...
  &\equiv \sp{\mu \p{2\ell-n+1} \Gamma_z^* \Gamma_\mu
    - \mu n \Gamma_\bmu^*\Gamma_z}
  S_\mu^{\ell+1} \p{\mu+S_\z}^m S_\bmu^n \notag \\
  &\qquad + \p{\Gamma_z^* \Gamma_\mu - \Gamma_\bmu^*\Gamma_z}
  S_\mu^{\ell+1} S_\z \p{\mu+S_\z}^m S_\bmu^n \notag \\
  &\qquad - \sp{\mu\p{\ell+1} \Gamma_z^* \Gamma_\mu
    - \mu\p{2n-\ell} \Gamma_\bmu^* \Gamma_z}
  S_\mu^{\ell+1} S_\z^m S_\bmu^n \notag \\
  &\qquad - \p{\Gamma_z^* \Gamma_\mu - \Gamma_\bmu^*\Gamma_z}
  S_\mu^{\ell+1} S_\z^{m+1} S_\bmu^n,
  \allowdisplaybreaks \\
  \tilde M_{\ell mn;\mu}^{(\Gamma)}
  &= \sp{\mu\p{2\ell-n}\p{n-1} \Gamma_z^* \Gamma_\mu
    - \mu\p{n-1}^2 \Gamma_\bmu^* \Gamma_z}
  S_\mu^\ell S_\z^m S_\bmu^{n-1} \notag \\
  &\qquad + \sp{\p{4\ell-n-1} \Gamma_z^* \Gamma_\mu
    - 3\p{n-1} \Gamma_\bmu^* \Gamma_z}
  S_\mu^\ell S_\z^{m+1} S_\bmu^{n-1} \notag \\
  &\qquad +2\mu \p{\Gamma_z^* \Gamma_\mu - \Gamma_\bmu^* \Gamma_z}
  S_\mu^\ell S_\z^{m+2} S_\bmu^{n-1},
  \allowdisplaybreaks \\
  \tilde Q_{\ell mn;\mu}^{(\Gamma)}
  &\equiv \Gamma_\bmu^* \Gamma_\mu \tilde P_{\ell mn;\mu}
  + \f12 \tilde L_{\ell mn;\mu}^{(\Gamma)}
  - \f12 n \tilde M_{\ell mn;\mu}^{(\Gamma)},
\end{align}
in terms of which
\begin{align}
  \D\p{\Gamma; S_\mu^\ell S_\z^m S_\bmu^n}
