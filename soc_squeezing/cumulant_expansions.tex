...
\begin{align}
  ...
  = \sum_{\v\rho} \sp{\prod_{\mu,\nu,\kappa}
    \p{\eta_{\mu\nu\kappa}}^{\tilde\rho_\kappa}}
  \prod_{\kappa,a} \sigma_{\kappa}^{(\tilde K^{\v\rho\kappa}_a)},
\end{align}
where $\tilde\rho_\kappa$ is the number of elements in $\v\rho$ equal
to $\kappa$, and $\tilde K^{\v\rho\kappa}_a$ indexes the $a$-th
operator of type $\sigma_\kappa$ for each choice of $\v\rho$, such
that for any fixed $\v\rho$ we have
$\set{\tilde K^{\v\rho\kappa}_a}=\set{K^{\mu\nu}_b}$.
