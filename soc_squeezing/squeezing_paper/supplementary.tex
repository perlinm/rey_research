\documentclass[aps,prx,superscriptaddress,notitlepage,onecolumn,12pt]{revtex4-1}
...
In principle, spin-changing decoherence compromises the validity of the OAT model, as its perturbative derivation in Appendix A of the main text relies on spin population remaining primarily within the Dicke manifold.
...
\caption{{\bf Relative error} between maximal squeezing (measured in dB) obtained by the OAT [Eqn.~(4)] and spin [Eqn.~(3)] models of the main text in a system of 20 particles.
