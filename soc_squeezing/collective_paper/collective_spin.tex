...
Here compute the expectation values of all collective spin operators
...
$\ket{k}\propto S_+^{S+k}\ket{\dn}^{\otimes N}$ with
$S\equiv N/2$ and $S_\z\ket{k}=k\ket{k}$:
\begin{align}
  \ket{\theta,\phi}
...
\end{align}
In order to compute expectation values of collective spin operators we
expand
\begin{align}
...
\end{align}
with $\bmu\equiv-\mu\in\set{+1,-1}$ and
\begin{align}
