...
\begin{figure*}
  ...
  \caption{Magnitude and phase of the two-time connected correlator
    ...
    using the TST expansion in Eq.~\eqref{eq:TST} with $M=20$.}
  \label{fig:two_time}
\end{figure*}
...
and need to be computed separately for any particular initial state of
interest; expectation values with respect to spin-polarized (Gaussian)
states are provided in Appendix \ref{sec:initial_conditions}.  In
practice, we further collect terms in \eqref{eq:tutorial_TST} to write
\begin{align}
