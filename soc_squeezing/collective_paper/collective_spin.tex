...
$\abs{\bk{\hat\S_{\v n}\p{t}}}\gtrsim S^{\abs{\v n}}$.  The sudden and
...
presence of strong decoherence.  The better performance of TNT is a
consequence of the fact that TNT initially generates squeezing at a
faster rate than OAT or TAT, thereby allowing it to produce more
...
small system in Appendix \ref{sec:small_system}.  Strong-decoherence
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Robustness of squeezing generated by the twist-and-turn (TNT)
  model}
\label{sec:small_system}

% \begin{figure}
%   \centering
%   \includegraphics{decoherence_strong_small.pdf}
%   \caption{Spin squeezing of $N=100$ spins initially in $\ket\X$ with
%     spontaneous decay, excitation, and dephasing of individual spins
%     at rates $\gamma_-=\gamma_+=\gamma_\z=2\chi$.  Computed computed
%     using exact methods (solid line), quantum trajectory simulations
%     with $10^4$ trajectories (dots), and the TST expansion in
%     Eq.~\eqref{eq:TST} with $M=35$ (dashed lines).}
%   \label{fig:decoherence_strong_small}
% \end{figure}
