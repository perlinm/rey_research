...
relevant e.g.~for spin squeezing protocols.
...
\begin{figure*}
  ...
  \caption{Magnitude and phase of the two-time connected correlator
    ...
    suppressed by other forms of decoherence.  The general type of
    decoherence (namely spin decay, excitation, or dephasing) also
    leaves a signature on the phase $\phi\p{t}$ of $C\p{t}$.  Results
    computed using the TST expansion in Eq.~\eqref{eq:TST} with
    $M=20$.}
  \label{fig:two_time}
\end{figure*}
