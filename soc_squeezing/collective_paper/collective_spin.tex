...
\begin{figure*}
  ...
  Eq.~\eqref{eq:four_point}. \label{fig:four_point}]
...
% TODO: in contrast to typical OTOCs, here the operators "almost commute" -- up to 1/N terms

% TODO: mention short-time expansion, see only polynomial growth

% TODO: figures 3a, 3b: 3 panels each; no decoherence, decoherence in fig. 2, and strong decoherence

% TODO: add vertical axis labels for G_- and g_- (?)
